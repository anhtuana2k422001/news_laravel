...
<h3 class="sidebar-heading">Bài viết mới nhất</h3>
    @foreach($recent_posts as $recent_posts)
        <div class="f-blog">
            ...
            <a href="{{ route('posts.show', $recent_posts) }}" class="blog-img" style="background-image: url({{ asset($recent_posts->image ? 'storage/' .$recent_posts->image->path : 'storage/placeholders/placeholder-image.jpg'  )}});"></a>
            <div class="desc">
